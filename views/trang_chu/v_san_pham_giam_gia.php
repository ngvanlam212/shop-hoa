              ...
              <div class="per-product clearfix">
                <div class="images-container">
                  <div class="product-hover">
                    <a href="chi_tiet_hoa.php?id='.$giam_gia["MaHoa"].'" title="'.$giam_gia["TenHoa"].'" class="product-image">
                ...
                <div class="products-textlink product-featured-custom clearfix">
                  <h2 class="product-name">
                    <a href="chi_tiet_hoa.php?id='.$giam_gia["MaHoa"].'" title="'.$giam_gia["TenHoa"].'">'.$giam_gia["TenHoa"].'</a>
                  </h2>
                  <div class="price-box">
                    <p class="old-price">
                    ...
                    <a href="chi_tiet_hoa.php?id='.$giam_gia["MaHoa"].'" class="minimal-price-link">
