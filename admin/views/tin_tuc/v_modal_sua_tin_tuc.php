<?php 
  foreach ($doc_tin_tuc as $tin_tuc) {
    echo '<div class="modal fade" id="edit'.$tin_tuc["MaTT"].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="loai_tin">
                  ...
                  foreach ($doc_loai_tin as $loai_tin) {
                    echo '<option value="'.$loai_tin["MaLoaiTin"].'">'.$loai_tin["TenLoaiTin"].'</option>';
                  }
