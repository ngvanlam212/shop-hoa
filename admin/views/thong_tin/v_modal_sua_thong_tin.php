<?php 
  foreach ($doc_thong_tin as $thong_tin) { 
      echo '<div class="modal fade" id="edit'.$thong_tin["id"].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
          <form method="POST" id="uploadForm'.$thong_tin["id"].'" action="thong_tin.php" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="tieu_de" value="'.$thong_tin["id"].'" autocomplete="off">
            </div>
            <div class="form-group">
