...
foreach ($doc_hoa as $hoa) { 
  echo '<div class="modal fade" id="edit'.$hoa["MaHoa"].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="max-width: 875px;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">'.$hoa["TenHoa"].'</h5>
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="loai_hoa">';
                  foreach ($doc_loai_hoa as $loai_hoa) {
                    echo '<option value="'.$loai_hoa["MaLoai"].'">'.$loai_hoa["TenLoai"].'</option>';
                  }
