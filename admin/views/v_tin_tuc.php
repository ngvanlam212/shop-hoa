...
<div class="card mb-3">
    <div class="card-header">
        <div class="row">
            ...
            <div class="col col-6">
                <button type="button" class="btn btn-success float-right" data-toggle="modal" data-target="#add">Thêm
                    tin tức</button>
            </div>
        </div>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <?php require_once "./views/tin_tuc/v_danh_sach_tin_tuc.php" ?>
        </div>
        <?php require_once "./views/tin_tuc/v_modal_them_tin_tuc.php" ?>
